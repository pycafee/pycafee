...
class Test_two_side(unittest.TestCase):
    ...
    def test_kurtosis_not_normal_details(self):
        ...
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        result = False
        if "Como a estatistica calculada para a curtose (-1.975) é um valor menor do que o valor crítico inferior (1.959), temos evidências para rejeitar a hipoótese nula, e podemos dizer que a distribuição não apresenta curtose similar a curtose de uma distribuição Normal (com 95.0% de confiança)." in conclusion:
            result = True
        self.assertTrue(result, msg="wrong conclusion ")
        ...
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        result = False
        if "Como a estatistica calculada para a curtose (2.802) é um valor maior do que o valor crítico superior (1.959), temos evidências para rejeitar a hipoótese nula, e podemos dizer que a distribuição não apresenta curtose similar a curtose de uma distribuição Normal (com 95.0% de confiança)." in conclusion:
            result = True
        self.assertTrue(result, msg="wrong conclusion ")
