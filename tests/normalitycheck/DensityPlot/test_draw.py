...
class Test_axes_test_draw(unittest.TestCase):
    ...
    def test_bw_method(self):
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            self.assertEqual(x[5], 4.307507507507507, msg="Something wrong with kde estimation")
            self.assertEqual(y[5], 0.24553462195266776, msg="Something wrong with kde estimation")
            self.assertEqual(x[42], 4.363063063063063, msg="Something wrong with kde estimation")
            self.assertEqual(y[42], 0.3105878575930724, msg="Something wrong with kde estimation")
            self.assertEqual(x[71], 4.406606606606607, msg="Something wrong with kde estimation")
            self.assertEqual(y[71], 0.36020389827333554, msg="Something wrong with kde estimation")
            self.assertEqual(x[90], 4.435135135135135, msg="Something wrong with kde estimation")
            self.assertEqual(y[90], 0.39163910716800165, msg="Something wrong with kde estimation")
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            self.assertEqual(x[5], 4.307507507507507, msg="Something wrong with kde estimation")
            self.assertEqual(y[5], 0.24645513104212644, msg="Something wrong with kde estimation")
            self.assertEqual(x[42], 4.363063063063063, msg="Something wrong with kde estimation")
            self.assertEqual(y[42], 0.3097433651366933, msg="Something wrong with kde estimation")
            self.assertEqual(x[71], 4.406606606606607, msg="Something wrong with kde estimation")
            self.assertEqual(y[71], 0.3588525778348663, msg="Something wrong with kde estimation")
            self.assertEqual(x[90], 4.435135135135135, msg="Something wrong with kde estimation")
            self.assertEqual(y[90], 0.39041165000025746, msg="Something wrong with kde estimation")
            self.assertEqual(len(central_tendency), 0, msg="Central tendency not empty for default parameters")
            plt.close()
    ...
    def test_which(self):
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            self.assertEqual(central_tendency['mode'][0][1], 1.058253577481665, msg="wrong kde for mode")
            self.assertEqual(central_tendency['mode'][1][0], 5.0, msg="wrong mode")
            self.assertEqual(central_tendency['mode'][1][1], 1.117529174648972, msg="wrong kde for mode")
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            self.assertEqual(central_tendency['mean'][1], 0.11002722425258299, msg="wrong kde for mean")
            self.assertEqual(central_tendency['median'][0], 5.0, msg="wrong median")
            self.assertEqual(central_tendency['median'][1], 0.11002722425258299, msg="wrong kde for median")
            filhos = axes.get_children()
            mean = filhos[1].get_label()
            self.assertEqual(mean, "Mean")
            median = filhos[2].get_label()
...
class Test_None_test_draw(unittest.TestCase):
    ...
    def test_basic_plot(self):
        with patch('matplotlib.pyplot.show') as p:
            ...
            self.assertEqual(y[1], 0.23851082126842368, msg="Something wrong with kde estimation")
            self.assertEqual(y[10], 0.25433748049114124, msg="Something wrong with kde estimation")
            self.assertEqual(y[85], 0.3834491086323924, msg="Something wrong with kde estimation")
            self.assertEqual(y[95], 0.39977420644640943, msg="Something wrong with kde estimation")
    ...
    def test_width_height(self):
        with patch('matplotlib.pyplot.show') as p:
            ...
            x, y, z, axes = test.draw(self.x)
            ax_h, ax_w = axes.bbox.height, axes.bbox.width
            self.assertEqual(ax_h, 526.7222222222222, "wrong defalt height")
            self.assertEqual(ax_w, 1118.5972222222222, "wrong defalt width")
            plt.close()
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            ax_h, ax_w = axes.bbox.height, axes.bbox.width
            self.assertEqual(ax_h, 426.72222222222223, "wrong personalized height")
            self.assertEqual(ax_w, 418.59722222222223, "wrong personalized width")
            plt.close()
    ...
    def test_tight(self):
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            ax_h, ax_w = axes.bbox.height, axes.bbox.width
            self.assertEqual(ax_h, 462.0, "wrong defalt height")
            self.assertEqual(ax_w, 930.0, "wrong defalt width")
            plt.close()
        ...
        with patch('matplotlib.pyplot.show') as p:
            ...
            ax_h, ax_w = axes.bbox.height, axes.bbox.width
            self.assertEqual(ax_h, 385.0, "wrong personalized height")
            self.assertEqual(ax_w, 387.5, "wrong personalized width")
            plt.close()
